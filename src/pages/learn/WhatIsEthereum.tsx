...
export default function WhatIsEthereum() {
  return (
    ...
    >
      ...
      <p>
        以太坊（Ethereum）是一個
        <strong>去中心化的程式執行平台</strong>。任何人都能在上面部署「智能合約」——會自動執行、沒人能偷改的程式。它不歸任何一家公司管，由全世界的節點一起維護。
      </p>
      <p>
      ...
      <h2>跟比特幣有什麼不同？</h2>
      <p>
        比特幣比較像「數位黃金」，主要功能是儲值與轉帳。以太坊則更像「可程式化的金融基礎建設」：除了轉帳，還能跑借貸、交易所、NFT、遊戲等各種應用。簡單說——
